...
class ExplorerApiJobOutputFilesTest extends WrkTestCase {
  fetchZoweVersions = true;

  name = "Test explorer api endpoint /api/v1/jobs/{jobName}/{jobId}/files";
  endpoint = '/api/v1/jobs/SDSF/{jobId}/files';
...
new ExplorerApiJobOutputFilesTest().init();
